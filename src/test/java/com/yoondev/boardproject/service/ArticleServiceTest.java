...
class ArticleServiceTest {
    ...
    @Test
    public void givenArticleId_whenSearchArticleWithComments_thenReturnArticleWithComments(){
        // Given
        Long articleId = 1L;
    ...
    @Test
    public void givenNoneexistentArticleId_whenSearchArticleWithComments_thenThrowsException(){
        // Given
        Long articleId = 0L;
    ...
    @DisplayName("검색어와 없이 게시글을 해시태그 검색하면, 게시글 페이지를 반환한다.")
    @Test
    ...
    @Test
    public void givenNothing_whenCountingArticles_thenReturnArticleCount(){
        // Given
        long expected = 0L;
